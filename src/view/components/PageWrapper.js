                            ...
                            <ul className="nav navbar-nav flex-child-menu menu-left">
                                ...
                                <li className="dropdown first">
                                    ...
                                    <ul className="dropdown-menu level1">
                                        <li className="dropdown">
                                            <a href="#" className="dropdown-toggle" data-toggle="dropdown">Movie
                                                grid<i className="ion-ios-arrow-forward"/></a>
                                ...
                                <li className="dropdown first">
                                    ...
                                    <ul className="dropdown-menu level1">
                                        ...
                                        <li className="it-last"><a href="celebritysingle.html">celebrity single</a>
                                        </li>
                                    </ul>
                                </li>
                                <li className="dropdown first">
                        ...
                        <div className="col-md-12">
                            <div className="hero-ct">
                                ...
                                <ul className="breadcumb">
                                    ...
                                    <li><span className="ion-ios-arrow-right"/> movie listing</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="col-md-8 col-sm-12 col-xs-12">
                            <div className="topbar-filter">
                                ...
                                <a href="movielist.html" className="list"><i
                                    className="ion-ios-list-outline active"/></a>
                                <a href="moviegrid.html" className="grid"><i className="ion-grid"/></a>
                            </div>
                                    ...
                                    <form className="form-style-1" action="#">
                                        <div className="row">
                                            ...
                                            <div className="col-md-12 form-it">
                                                ...
                                                <select>
                                                    <option value="range">-- Select the rating range below --
                                                    </option>
                                                    <option value="saab">-- Select the rating range below --
                                                    </option>
                                                    <option value="saab">-- Select the rating range below --
                                                    </option>
                                                    <option value="saab">-- Select the rating range below --
                    ...
                    <div className="flex-parent-ft">
                        ...
                        <div className="flex-child-ft item2">
                            ...
                            <ul>
                                ...
                                <li><a href="#">Pagina de peliculas</a></li>
